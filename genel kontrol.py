...
#  Donanım : Raspberry Pi 5 + MCP2515 (SocketCAN) + GPIO LED'ler
#
#  Motor:
...
#    E → LED1 toggle
#    F → LED2 toggle
#    G → LED3=ON  LED4=ON  LED5=ON  LED6=OFF  LED7=ON
#    H → LED3=ON  LED4=ON  LED5=ON  LED6=OFF  LED7=ON
#    I → LED3=ON  LED4=OFF LED5=ON  LED6=OFF  LED7=ON
...
# ============================================================
#  GPIO PIN ATAMALARI (BCM numaraları)
# ============================================================
LED_PINS = {
    1:  17,   # LED1  → GPIO17 (Pin 11)
    2:  18,   # LED2  → GPIO18 (Pin 12)
    3:  27,   # LED3  → GPIO27 (Pin 13)
    4:  22,   # LED4  → GPIO22 (Pin 15)
    5:  23,   # LED5  → GPIO23 (Pin 16)
    6:  24,   # LED6  → GPIO24 (Pin 18)
    7:  25,   # LED7  → GPIO25 (Pin 22)
...
class KY170Controller:
    def __init__(self):
        ...
        self.led_states: dict                 = {i: False for i in range(1, 12)}
    ...
    # ----------------------------------------------------------
    #  GPIO LED YARDIMCI FONKSİYONLARI
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    def key_g(self):
        self._led_set(3, True)
        self._led_set(4, True)
        self._led_set(5, True)
        self._led_set(6, False)
        self._led_set(7, True)
        print("  [G] LED3=ON  LED4=ON  LED5=ON  LED6=OFF  LED7=ON")
    ...
    def key_h(self):
        ...
        self._led_set(6, False)
        self._led_set(7, True)
        print("  [H] LED3=ON  LED4=ON  LED5=ON  LED6=OFF  LED7=ON")

    def key_i(self):
        self._led_set(3, True)
        self._led_set(4, False)
        self._led_set(5, True)
        self._led_set(6, False)
        self._led_set(7, True)
        print("  [I] LED3=ON  LED4=OFF  LED5=ON  LED6=OFF  LED7=ON")
    ...
    def run(self):
        ...
        print("  G → LED3,4,5,7=ON  LED6=OFF")
        print("  H → LED3,4,5,7=ON  LED6=OFF")
        print("  I → LED3,5,7=ON    LED4,6=OFF")
