...
#            + USB Kamera (program açılınca otomatik başlar)
#
#  Motor:
...
# ============================================================
#  KAMERA THREAD  (ana döngüyü bloklamaz)
# ============================================================
class CameraThread(threading.Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.is_set():
            ...
            # 1ms bekle, kamera penceresinde Q'ya basılırsa sadece pencere kapanır
...
class KY170Controller:
    def __init__(self):
        ...
        # --- Kamera başlat ---
        print("  Kamera başlatılıyor...", end=" ", flush=True)
